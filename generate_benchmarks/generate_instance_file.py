...
def gen_instances_file(net_dir, nets, prop_dir, images_idxs, confs, eps, file_path, timeout=2000):
    if not isinstance(images_idxs, list):
...
if __name__ == '__main__':
    ...
    prop_dir = '/home/afzal/tools/networks/mod_props/conf/props'
    image_idxs = [0,1,2]
    confs = [0,60,90]
    eps = [0.04, 0.06]
    file_path = '/home/afzal/tools/networks/mod_props/conf'
    gen_instances_file(net_dir, nets, prop_dir, image_idxs, confs, eps, file_path)
